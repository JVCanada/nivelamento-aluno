...
print "A fase atual é: "
puts fase_pandemica(0.7,0.6,0.6)

print "A fase atual é: "
puts fase_pandemica(0.6,0.6,0.7)

print "A fase atual é: "
puts fase_pandemica(0.7,0.6,0.85)
...
print "A fase atual é: "
puts fase_pandemica(0.7,-3.0,0.6)

print "A fase atual é: "
puts fase_pandemica(0.7,0.6,1.6)


# Comandos para entrada do usuário (não está funcionando!):
...
# print "A fase atual é: "
# fase_pandemica(taxa_de_vacinacao, fator_de_transmissao, taxa_ocupacao_leitos)
